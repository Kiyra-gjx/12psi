 ...
 * 采购退货单详情数据传输模型
 */
class getreturndetailDTO : public oatpp::DTO {
    DTO_INIT(getreturndetailDTO, DTO);
    // 编号
 ...
 * 采购退货单详情列表分页数据传输模型
 */
class getreturndetailPageDTO : public PageDTO<getreturndetailDTO::Wrapper> {
    DTO_INIT(getreturndetailPageDTO, PageDTO<getreturndetailDTO::Wrapper>);
};
