...
#ifndef _BRE_INFO_DO_
#define _BRE_INFO_DO_
#include "DoInclude.h"
...
public:
	BreInfoDO() : BaseDO("bre_info")  // 假设表名为bre_info，需根据实际表名调整
	{
		// 主键字段
...
// 给BreInfoDO智能指针设定一个别名方便使用
typedef std::shared_ptr<BreInfoDO> PtrBreInfoDO;
#endif // !_BRE_INFO_DO_