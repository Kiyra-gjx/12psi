...
#include "domain/vo/ExReportDeVO.h"
...
public:
	...
	// 3.1 定义导出接口描述
	API_DEF_ENDPOINT_INFO_QUERY_AUTH(ZH_WORDS_GETTER("file.DeEx"), exportSample, ExReportDeQuery, Void, API_TAG);
	// 3.2 定义导出接口处理
	API_HANDLER_ENDPOINT_OPTION_AUTH(API_M_GET, "/purchasedingdan/reportDeExport", exportSample, QUERIES(QueryParams, queryParams),
