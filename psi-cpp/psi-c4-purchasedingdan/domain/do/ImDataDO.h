...
// 定义一个智能指针别名方便使用
typedef std::shared_ptr<ImDataDO> PtrFileDO;

/**
 * 文件视图对象，关联一些外表的字段
 */
class FileViewDO : public ImDataDO {
	// 文件类型名称
...
// 定义一个智能指针别名方便使用
typedef std::shared_ptr<FileViewDO> PtrImDataViewDO;
