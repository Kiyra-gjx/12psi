#ifndef _PURCHASEORDERDETAILSDO_H_
#define _PURCHASEORDERDETAILSDO_H_

#include "DoInclude.h"

class PurchaseOrderDetailsDO : public BaseDO {
...
public:
	PurchaseOrderDetailsDO() : BaseDO("bor_info") {
		// 主键
...
typedef std::shared_ptr<PurchaseOrderDetailsDO> PtrPurchaseOrderDetailsDO;


#endif // _PURCHASEORDERDETAILSDO_H_
