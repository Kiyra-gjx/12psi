...
// 定义一个智能指针别名方便使用
typedef std::shared_ptr<AnnexDO> PtrAnnexDO;

/**
 * 文件视图对象，关联一些外表的字段
 */
class AnnexViewDO : public AnnexDO {
	// 文件类型名称
...
// 定义一个智能指针别名方便使用
typedef std::shared_ptr<AnnexViewDO> PtrAnnexViewDO;
