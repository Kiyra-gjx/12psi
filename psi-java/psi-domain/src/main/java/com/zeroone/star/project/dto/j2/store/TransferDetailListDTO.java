...
@Data
@ApiModel("调拨单详细")
/*除额外标注，其余字段都能在is_swap_info表里找到*/
public class TransferDetailListDTO {
    @ApiModelProperty(value = "隐藏属性唯一id",required = true , example = "1")
    private int id;
    @ApiModelProperty(value = "商品名称，is_goods表里",required = true, example = "刀具")
    private String name;
    @ApiModelProperty(value = "商品编号，is_goods表里",required = true, example = "0003")
    private String number;
    @ApiModelProperty(value = "规格型号，is_goods表里",required = true, example = "DJ-0001")
    private String spec;
