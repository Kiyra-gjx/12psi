...
@Service
public class SwapServiceImpl extends ServiceImpl<SwapMapper, Swap> implements ISwapService {
    ...
    public ArrayList<TransferListDTO> getTransferListDTOList(List<String> idList) {
        ArrayList<TransferListDTO> transferListDTO = new ArrayList<>();
        for (String id : idList) {
            TransferListDTO transferListDTO1 = swapMapper.getTransferListDTO(id);
            transferListDTO.add(transferListDTO1);
        }
